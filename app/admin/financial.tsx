...
const StatBox = ({ title, value, sub, trend }: any) => (
    <View style={styles.statBox}>
        ...
        <View style={styles.statFooter}>
            <Text style={[styles.statSub, { color: trend === 'up' ? '#10b981' : '#ef4444' }]}>{sub}</Text>
        </View>
    </View>
);
...
export default function FinancialManager() {
    ...
    // Placeholder for transactions list (could be separate query later)
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.statRow}>
                    <StatBox title="Current MRR" value={`$${(stats?.totalRevenue ?? 0).toLocaleString()}`} sub="+12% vs last month" trend="up" />
                    <StatBox title="Active Subs" value={(stats?.premiumUsers ?? 0).toString()} sub="+4% new this week" trend="up" />
                    <StatBox title="Refund Rate" value="0.8%" sub="-2% vs avg" trend="up" />
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.plansGrid}>
                        <View style={styles.planCard}>
                            ...
                            <Text style={styles.planDescription}>Core premium features with monthly flexibility.</Text>
                            <View style={styles.planDivider} />
                            <TouchableOpacity style={styles.editPlanButton}>
                                <Text style={styles.editPlanText}>Configure Plan</Text>
                        ...
                        <View style={styles.planCard}>
                            ...
                            <Text style={styles.planDescription}>Save 40% with the full annual membership.</Text>
                            <View style={styles.planDivider} />
                            <TouchableOpacity style={styles.editPlanButton}>
                                <Text style={styles.editPlanText}>Configure Plan</Text>
                                <ArrowRight size={14} color="#2563eb" />
