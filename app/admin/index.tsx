            ...
            <View style={styles.sectionRow}>
                ...
                <View style={[styles.card, { flex: 1 }]}>
                    ...
                    <View style={styles.insightItem}>
                        ...
                        <Text style={styles.insightText}>Premium users up 14%</Text>
                    </View>
                    <View style={styles.insightItem}>
                        <View style={[styles.dot, { backgroundColor: '#10b981' }]} />
                        <Text style={styles.insightText}>New recipe engagement high</Text>
                    </View>
                    <View style={styles.insightItem}>
                        <View style={[styles.dot, { backgroundColor: '#f59e0b' }]} />
                        <Text style={styles.insightText}>Waitlist growing (+240)</Text>
                    </View>
                </View>
            </View>
