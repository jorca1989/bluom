...
export default function SettingsScreen() {
    ...
    // Unit preferences (local for now as schema doesn't have these fields yet)
    ...
    useEffect(() => {
        ...
        // Sync goals from Convex if available
        if (convexUser) {
            setTempGoals({
                    ...
                    <View style={styles.itemsList}>
                        <TouchableOpacity style={styles.item} activeOpacity={0.7} onPress={() => setShowUnitsModal(true)}>
                            <View style={styles.itemLeft}>
                                ...
                                <Text style={styles.itemValue}>{tempUnits.weight}, {tempUnits.height}, {tempUnits.distance}</Text>
                            </View>
                            <Ionicons name="chevron-forward" size={18} color="#94a3b8" />
                        </TouchableOpacity>
                ...
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <View style={styles.modalBody}>
                            ...
                            <TouchableOpacity style={styles.saveButton} onPress={() => setShowUnitsModal(false)}>
