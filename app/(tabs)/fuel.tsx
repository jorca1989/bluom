...
export default function FuelScreen() {
  ...
  const [waterUnit, setWaterUnit] = useState<'8oz' | '500ml' | '1cup'>('8oz');
  ...
  const waterUnits = useMemo(
    () => [
      { value: '8oz' as const, label: '8 fl oz', ml: 237 },
      { value: '500ml' as const, label: '500 ml', ml: 500 },
      { value: '1cup' as const, label: '1 cup (250ml)', ml: 250 },
    ],
    []
  );
    ...
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        <View style={styles.screenLoadingContainer}>
          ...
          <Text style={styles.loadingText}>Loading Fuel…</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (!convexUser) {
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        <View style={styles.screenLoadingContainer}>
          <Text style={styles.errorText}>Complete onboarding to see Fuel</Text>
      ...
      >
          ...
          <View style={styles.waterHeader}>
            <View style={styles.waterHeaderLeft}>
              ...
              <View>
                ...
                <Text style={styles.waterSubtitle}>{Math.round(daily?.waterOz ?? 0)}oz</Text>
              </View>
            </View>
        ...
        <View style={styles.mealsSection}>
          ...
          >
            ...
            {!convexUser.isPremium && <Ionicons name="diamond" size={16} color="#f59e0b" />}
          </TouchableOpacity>
        </View>
      </ScrollView>
              ...
              {waterAmount && (
                <View style={styles.waterPreview}>
                  <Text style={styles.waterPreviewText}>
                    ...
                    {Math.round(((waterUnits.find((u) => u.value === waterUnit)?.ml || 237) * parseFloat(waterAmount)) / 29.5735)} fl oz
                  </Text>
                </View>
              )}
