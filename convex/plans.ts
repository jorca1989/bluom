...
export const generateNutritionPlan = internalMutation({
  ...
  handler: async (ctx, args) => {
    ...
    const totalMeals = user.mealsPerDay;
    const caloriesPerMeal = user.dailyCalories / totalMeals;
    ...
    mealTemplates.push({
      mealType: "breakfast",
      calories: user.dailyCalories * 0.25,
      protein: user.dailyProtein * 0.25,
      carbs: user.dailyCarbs * 0.25,
      fat: user.dailyFat * 0.25,
      suggestions: [
    ...
    mealTemplates.push({
      mealType: "lunch",
      calories: user.dailyCalories * 0.35,
      protein: user.dailyProtein * 0.35,
      carbs: user.dailyCarbs * 0.35,
      fat: user.dailyFat * 0.35,
      suggestions: [
    ...
    mealTemplates.push({
      mealType: "dinner",
      calories: user.dailyCalories * 0.3,
      protein: user.dailyProtein * 0.3,
      carbs: user.dailyCarbs * 0.3,
      fat: user.dailyFat * 0.3,
      suggestions: [
    ...
    mealTemplates.push({
      mealType: "snack",
      calories: user.dailyCalories * 0.1,
      protein: user.dailyProtein * 0.1,
      carbs: user.dailyCarbs * 0.1,
      fat: user.dailyFat * 0.1,
      suggestions: [
        "Protein bar",
    ...
    if (user.isPremium) {
      mealTemplates.push({
        ...
        protein: user.dailyProtein / totalMeals,
        carbs: user.dailyCarbs / totalMeals,
        fat: user.dailyFat / totalMeals,
        suggestions: [
    ...
    const planId = await ctx.db.insert("nutritionPlans", {
      ...
      proteinTarget: user.dailyProtein,
      carbsTarget: user.dailyCarbs,
      fatTarget: user.dailyFat,
      mealTemplates,
      isActive: true,
      createdAt: Date.now(),
    });
